...
export default function Home() {
  return (
    <main className="bg-whiteivory-500 min-h-screen w-full flex flex-col items-center justify-center">
      ...
      <div className="flex flex-col px-6 lg:flex-row lg:max-w-[1015px] items-center justify-center">
        <div className="lg:w-2/3 relative">
          ...
          <Typography
            font="montserrat"
            className="my-8 z-40 lg:pr-16 relative"
            variant="bt"
          >
            Hello 👋🏻 <br className="lg:hidden" /> I&apos;m Nadia Lovely, a
            frontend developer who turns complex ideas into seamless digital
            experiences. My passion for business processes and innovation led me
            to major in Information Systems. Beyond coding, I dive into business
            plan competitions, bringing creative solutions to life. From
            startup, software house, university comitte, to freelancing,
          ...
          <NextImage
            ...
            className="hidden lg:block absolute w-[500px] right-24 -bottom-[4.3%] z-10 "
          />
        </div>
        ...
        <div className="relative lg:w-1/3 lg:pl-6 ">
          ...
          <NextImage
            ...
            height={222}
            alt="half-eclipse"
            className="absolute bottom-0 w-72 -left-[31%] hidden lg:block"
          />
          <NextImage
            ...
            className="absolute top-2 w-44 -left-[47%] hidden lg:block -z-0"
          />
        </div>
      </div>
